...
<script lang="ts" setup>
  ...
  import { CURRENT_COMPANY, CURRENT_USER } from '@/store/mutation-types';
      ...
      try {
        ...
        if (code === ResultEnum.SUCCESS) {
          ...
          const userInfo = {
            ...
            current_company: pendingCompany,
          };

          userStore.setCurrentCompany(pendingCompany);
          userStore.setUserInfo(userInfo);
          storage.set(CURRENT_COMPANY, pendingCompany);
